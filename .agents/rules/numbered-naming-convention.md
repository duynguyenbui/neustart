...
2. Không sử dụng dấu cách trong tên. Thay mọi dấu cách bằng dấu gạch dưới (`_`).
3. Nếu người dùng yêu cầu đánh dấu một thư mục hoặc tệp là quan trọng, thêm hai dấu gạch dưới (`__`) vào cuối tên:
